...
class PurchaseOrderController extends Controller
{
    ...
    public function list()
    {
        ...
        $this->scopeAccessiblePurchaseOrders($purchaseOrders);
    ...
    {
        $purchaseOrder = $this->findAccessiblePurchaseOrder($id, ['items.sku.product', 'branch', 'warehouse', 'supplier']);
    ...
    {
        $purchaseOrder = $this->findAccessiblePurchaseOrder($id, ['items']);
    ...
    {
        $purchaseOrder = $this->findAccessiblePurchaseOrder($id, ['items.sku.product']);
    ...
    public function delete(Request $request): JsonResponse
    {
        ...
        $purchaseOrder = $this->findAccessiblePurchaseOrder($validated['id'], ['items']);
    ...
    private function findAccessiblePurchaseOrder(int|string $id, array $relations = []): PurchaseOrder
    {
        $query = PurchaseOrder::query()->with($relations);

        $this->scopeAccessiblePurchaseOrders($query);

        return $query->findOrFail($id);
    }

    private function scopeAccessiblePurchaseOrders(Builder $query): Builder
    {
        $user = auth()->user();
