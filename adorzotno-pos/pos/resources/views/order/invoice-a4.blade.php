    ...
    <div class="sheet">
        ...
        <div class="info-grid">
            ...
            <div class="info-card">
                ...
                <p><strong>Coupon:</strong> {{ $couponUsages->isNotEmpty() ? $couponUsages->pluck('code')->implode(', ') : 'N/A' }}</p>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="summary">
                <tbody>
                    ...
                    <tr>
                        <td>Included Coupon Discount <small style="color:#6b7280">({{ $couponUsages->pluck('code')->implode(', ') }})</small></td>
                        <td class="text-right">- {{ $moneyWithCurrency($couponDiscountTotal) }}</td>
                    </tr>
                    @endif
                    <tr>
                        <td>VAT</td>
