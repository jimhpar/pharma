                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" rows="4" placeholder="Enter address">{{ old('address') }}</textarea>
                                            @error('address')
                                            <div class="invalid-feedback">
                                                <i class="bx bx-radio-circle"></i>
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="footer-text" class="form-control @error('footer_text') is-invalid @enderror" name="footer_text" rows="4" placeholder="Enter footer text">{{ old('footer_text') }}</textarea>
                                            @error('footer_text')
                                            <div class="invalid-feedback">
                                                <i class="bx bx-radio-circle"></i>
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="news-letter-text">News Letter Text</label>
                                            <textarea id="news-letter-text" class="form-control @error('news_letter_text') is-invalid @enderror" name="news_letter_text" rows="4" placeholder="Enter newsletter text">{{ old('news_letter_text') }}</textarea>
                                            @error('news_letter_text')
                                            <div class="invalid-feedback">
                                                <i class="bx bx-radio-circle"></i>
                                                <strong>{{ $message }}</strong>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="google-map" class="form-control @error('google_map') is-invalid @enderror" name="google_map" rows="4" placeholder="Enter Google Map embed or URL">{{ old('google_map') }}</textarea>
                                            @error('google_map')
                                            <div class="invalid-feedback">
                                                <i class="bx bx-radio-circle"></i>
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="homepage-notice" class="form-control @error('homepage_notice') is-invalid @enderror" name="homepage_notice" rows="4" placeholder="Enter homepage notice">{{ old('homepage_notice') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="homepage-about-text" class="form-control summernote @error('homepage_about_text') is-invalid @enderror" name="homepage_about_text" rows="6" placeholder="Enter homepage about text">{!! old('homepage_about_text') !!}</textarea>
