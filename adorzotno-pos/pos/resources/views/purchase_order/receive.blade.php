                ...
                <div class="rx-card">
                    ...
                    <div class="rx-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2 col-6">
                                <span class="rx-field-label" style="color:#f59e0b">
                                    <i class="bi bi-tag-fill me-1"></i>Sale Price
                                </span>
                                <input type="number" min="0" step="0.01" class="form-control"
                                    name="items[{{ $index }}][sale_price]"
                                    placeholder="{{ $item->sale_price ?? $item->unit_price ?? '' }}"
                                    value="{{ old("items.$index.sale_price", $item->sale_price) }}"
                                    style="border-color:#fcd34d;font-weight:700">
                            </div>
                        </div>
