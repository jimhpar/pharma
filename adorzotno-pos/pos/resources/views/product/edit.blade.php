                ...
                <form id="productEditForm" method="post" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="section-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label>Brand</label>
                                <select class="form-control no-select2" id="brandSelectEdit" name="brand">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="text" name="generic_name" value="{{ old('generic_name', $product->generic_name) }}" placeholder="e.g. Paracetamol">
                            </div>
                            ...
                            <div class="col-md-3 col-xl mb-3">
                                ...
                                <div class="checkbox-stack">
                                    <input class="form-check-input" type="checkbox" id="is_flash_deals" name="is_flash_deals" value="1" {{ old('is_flash_deals', $product->is_flash_deals) ? 'checked' : '' }}>
                    ...
                    <div id="singleProductDiv" class="section-card" style="display: {{ $showSingleProductDiv ? 'block' : 'none' }};">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control" type="number" min="0" step="0.01" name="sale_price" value="{{ old('sale_price', $singleSku?->sale_price) }}" placeholder="= MRP if blank">
                            </div>
                            <div class="col-md-3 mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="variant-body" @if (!($errors->any() || $loop->first)) style="display:none;" @endif>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3"><label>Sale Price</label><input class="form-control" type="number" min="0" step="0.01" name="variants[{{ $index }}][sale_price]" value="{{ old("variants.$index.sale_price", $row['sale_price'] ?? '') }}" placeholder="= MRP if blank"></div>
...
<script>
    ...
    function collectSkuCodes(exceptInput) {
        return $('input[name="sku_code"], .variant-code').map(function () {
            if (this === exceptInput) {
                return null;
            }
    ...
    function generateSkuCode(idOrInput, callback) {
        var input = typeof idOrInput === 'string' ? document.getElementById(idOrInput) : idOrInput;
        ...
        $.ajax({
            ...
            data: {
                ...
                existing_codes: collectSkuCodes(input)
            },
                ...
                '<div class="card-body">' +
                    ...
                    '<div class="variant-body">' +
                        ...
                        '<div class="row">' +
                            ...
                            '<div class="col-md-3 mb-3"><label>Sale Price</label><input class="form-control" type="number" min="0" step="0.01" name="variants[' + index + '][sale_price]" placeholder="= MRP if blank"></div>' +
    ...
    $(document).on('click', '.generate-variant-code', function () {
        ...
        var card = $(this).closest('.variant-card').get(0);
        generateSkuCode(input, function () {
            updateVariantSummary(card);
        });
    });
