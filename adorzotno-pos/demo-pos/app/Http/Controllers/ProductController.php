...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $brand = Brand::query()->where('status', 'active')->orderBy('name')->get();
        $units = Unit::query()->where('status', 'active')->orderBy('name')->get();
        $taxRules = TaxRule::query()->where('status', 'active')->orderBy('name')->get();
    ...
    public function edit($productId)
    {
        ...
        $variations = Variation::query()->orderBy('type')->orderBy('value')->get()->groupBy('type');
