...
<div class="list-root">
    ...
    <div class="list-head">
        <div>
            <h2><i class="bi bi-arrow-return-left" style="color:#4f46e5;font-size:1.3rem"></i> Supplier Returns</h2>
            <p>Manage supplier return records</p>
        </div>
        <a href="{{ route('supplierReturn.create') }}" class="btn-new">
            <i class="bi bi-plus-lg" style="font-size:15px"></i> New Return
        </a>
    </div>
    ...
    <div class="filter-bar">
        <div class="filter-row">
            <div class="filter-search">
                ...
                <input type="text" id="fS" placeholder="Search return number or date…" autocomplete="off">
    ...
    <div class="table-card">
        <div class="table-responsive">
            <table id="supplierReturnTable" class="table table-striped mb-0"></table>
        </div>
    </div>
...
$(document).ready(function () {
    var _dt;
    var tbl = $('#supplierReturnTable').DataTable({
        processing: true, serverSide: true,
        ajax: { url:"{{ route('supplierReturn.list') }}", type:'POST', data:function(d){ d._token="{{ csrf_token() }}"; } },
        columns: [
            { title:'Return No', data:'return_no',      name:'return_no',      className:'text-center' },
            { title:'Date',      data:'return_date',    name:'return_date',    className:'text-center' },
            ...
            { title:'Supplier',  data:'supplier',       name:'supplier',       className:'text-center', orderable:false, searchable:false },
