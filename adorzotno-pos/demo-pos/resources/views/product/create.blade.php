                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" name="brand">
                                    ...
                                    @foreach ($brand as $brandItem)
                                        <option value="{{ $brandItem->id }}" {{ (string) old('brand') === (string) $brandItem->id ? 'selected' : '' }}>
                                            {{ $brandItem->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary" type="button" onclick="generateCode('variation_sku_code')">Generate</button>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label>Barcode</label>
