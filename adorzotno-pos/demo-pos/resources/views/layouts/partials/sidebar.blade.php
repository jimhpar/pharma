@php
    ...
    $isContentMenu = request()->routeIs('banner.*', 'categoryPromotion.*', 'review.*', 'setting.*');
    $isCatalogMenu = request()->routeIs('category.*', 'brand.*', 'variation.*', 'unit.*', 'taxRule.*', 'product.*');
    $isLocationMenu = request()->routeIs('branch.*', 'branchPrice.*', 'warehouse.*', 'supplier.*', 'customer.*', 'shipmentZone.*');
    $isInventoryMenu = request()->routeIs('purchaseOrder.*', 'inventoryAdjustment.*', 'stockTransfer.*', 'supplierReturn.*');
    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title">Finance & Content</li>
                ...
                <li class="sidebar-title">Insights</li>
